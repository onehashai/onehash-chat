...
<template>
  <form class="flex flex-wrap mx-0" @submit.prevent="createChannel()">
    ...
    <div
      v-if="!useMessagingService"
      class="w-full flex-shrink-0 flex-grow-0 max-w-full"
    >
    ...
    <div class="max-w-full w-full messagingServiceHelptext">
    ...
    <div v-if="useAPIKey" class="w-full flex-shrink-0 flex-grow-0 max-w-full">
