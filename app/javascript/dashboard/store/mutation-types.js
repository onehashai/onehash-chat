export default {
  ...
  // SHOPIFY DATA IN CONVERSATION
  SET_SHOPIFY_PRODUCTS: 'SET_SHOPIFY_PRODUCTS',
  SET_SHOPIFY_DISCOUNTS: 'SET_SHOPIFY_DISCOUNTS',
  ...
  // Contact Bookings
  SET_CONTACT_BOOKINGS_UI_FLAG: 'SET_CONTACT_BOOKINGS_UI_FLAG',
  SET_CONTACT_BOOKINGS: 'SET_CONTACT_BOOKINGS',
  ...
  SET_CAMPAIGN_CONTACTS: 'SET_CAMPAIGN_CONTACTS',
  ...
  // Shopify orders
  SET_SHOPIFY_ORDER_CANCELLATION_UI_FLAGS:
    'SET_SHOPIFY_ORDER_CANCELLATION_UI_FLAGS',
};
