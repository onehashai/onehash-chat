...
<template>
  ...
  >
    ...
    <div class="flex flex-row w-full gap-2">
      <slot name="leftOfInput" />
      <input
        v-bind="$attrs"
        v-model="model"
        :type="type"
        class="flex-1 min-w-0 block w-full border-none rounded-md shadow-sm bg-n-alpha-black2 appearance-none outline outline-1 focus:outline focus:outline-1 text-n-slate-12 placeholder:text-n-slate-10 sm:text-sm sm:leading-6 px-3 py-3"
        :class="{
